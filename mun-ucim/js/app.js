...
function countdown() {
      var endDate = new Date("2023-07-03 10:00:00"); // Tanggal akhir countdown
      ...
      var timerInterval = setInterval(function() {
        ...
        if (timeDiff < 0) {
          ...
          document.getElementById("countdown").textContent = "Acara Selesai!";
        }
      }, 1000);
    }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (name.length == 0) {
        ...
        div.innerHTML = `
        <h2 class="fsub1 mx-4 text-hideng" style="font-size: 1.2rem;">${name}</h2>
        `;

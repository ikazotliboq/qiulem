    ...
    var url = "https://script.google.com/macros/s/AKfycbwPeGh-O52DBuAPBhIPvANQbE_55eDHTt3WfNC9tzDL7jEctLu8YM6U00ICquUeRWbg/exec?action=read";
    ...
    outputHTML += "<div class='comment'><img src='https://raw.githubusercontent.com/qobilcdn/resource/main/images-wedding/qobil_IMG_20241014_142017.png' class='profile-picture'><div class='comment-details'><div class='am'>";
    
    if (record.kehadiran === "Hadir") {
    outputHTML +=  "<h4 class='commenter-name fsub1'>" + record.nama + "<i style='color: #124441; margin-left: 5px;'class='bi bi-check-circle-fill'></i></h4>";
    } else {
    ...
    const script_url = "https://script.google.com/macros/s/AKfycbwPeGh-O52DBuAPBhIPvANQbE_55eDHTt3WfNC9tzDL7jEctLu8YM6U00ICquUeRWbg/exec";

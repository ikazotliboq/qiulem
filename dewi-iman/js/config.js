    ...
    var url = "https://script.google.com/macros/s/AKfycbytd5HwXy_UvsCMxIG2_79JKwHBiiBclWdDt8K0DgyDULpiYKivd30c2r1U1_4e46qd/exec?action=read";
    ...
    outputHTML += "<div class='comment'><img src='https://raw.githubusercontent.com/qobilcdn/resource/main/images-wedding/qobil_IMG_20241011_160424.jpg' class='profile-picture'><div class='comment-details'><div class='am'>";
    
    if (record.kehadiran === "Hadir") {
    outputHTML +=  "<h4 class='commenter-name fsub1'>" + record.nama + "<i style='color: #C69B5C; margin-left: 5px;'class='bi bi-check-circle-fill'></i></h4>";
    } else {
   ...
   const script_url = "https://script.google.com/macros/s/AKfycbytd5HwXy_UvsCMxIG2_79JKwHBiiBclWdDt8K0DgyDULpiYKivd30c2r1U1_4e46qd/exec";

    ...
    var url = "https://script.google.com/macros/s/AKfycbxo3bnG3p8D16yW-kqkGXlg-7uIxqE_szc2h9oVy2i7BFNEav14T9vW1xbOYQZxshou/exec?action=read";
    ...
    outputHTML += "<div class='comment'><img src='https://i.postimg.cc/rpq9C6RF/IMG-20240313-210354.jpg' class='profile-picture'><div class='comment-details'><div class='am'>";
    
    if (record.kehadiran === "Hadir") {
    outputHTML +=  "<h4 class='commenter-name fsub1'>" + record.nama + "<i style='color: #68877A; margin-left: 5px;'class='bi bi-check-circle-fill'></i></h4>";
    } else {
    ...
    const script_url = "https://script.google.com/macros/s/AKfycbxo3bnG3p8D16yW-kqkGXlg-7uIxqE_szc2h9oVy2i7BFNEav14T9vW1xbOYQZxshou/exec";

    ...
    var url = "https://script.google.com/macros/s/AKfycbyCXSy_9MOGOh-ZowMVZPBsjOfbRRuUYVbRIaH_7atZeBAPJAVtsCN4U9Y20yKpilov6A/exec?action=read";
    ...
    outputHTML += "<div class='comment'><img src='https://raw.githubusercontent.com/qobilcdn/resource/main/images-wedding/qobil_IMG-20240807-WA0009.jpg' class='profile-picture'><div class='comment-details'><div class='am'>";
    
    if (record.kehadiran === "Hadir") {
    outputHTML +=  "<h4 class='commenter-name fsub1'>" + record.nama + "<i style='color: #7D2028; margin-left: 5px;'class='bi bi-check-circle-fill'></i></h4>";
    } else {
    outputHTML += "<p class='commenter-name fsub1'>" + record.nama + " <i style='color: #DA2427;' class='bi bi-x-circle-fill'></i></p>";
    }
    ...
    const script_url = "https://script.google.com/macros/s/AKfycbyCXSy_9MOGOh-ZowMVZPBsjOfbRRuUYVbRIaH_7atZeBAPJAVtsCN4U9Y20yKpilov6A/exec";

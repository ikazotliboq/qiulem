    ...
    var url = "https://script.google.com/macros/s/AKfycbwwC5SX_EWYfMlqktiyX2ulSVFtFBJMqSUaqLQ2kfoVRStOvTj4kmptR-exIRnP-h3c/exec?action=read";
    ...
    outputHTML += "<div class='comment'><img src='https://i.ibb.co.com/ZSFpdZj/IMG-20240623-221109.jpg' class='profile-picture'><div class='comment-details'><div class='am'>";
    
    if (record.kehadiran === "Hadir") {
    outputHTML +=  "<h4 class='commenter-name fsub1'>" + record.nama + "<i style='color: #B66935; margin-left: 5px;'class='bi bi-check-circle-fill'></i></h4>";
    } else {
    ...
    const script_url = "https://script.google.com/macros/s/AKfycbwwC5SX_EWYfMlqktiyX2ulSVFtFBJMqSUaqLQ2kfoVRStOvTj4kmptR-exIRnP-h3c/exec";

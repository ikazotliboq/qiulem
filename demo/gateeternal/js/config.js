    ...
    outputHTML += "<div class='comment'><img src='https://raw.githubusercontent.com/qobilcdn/resource/main/images-wedding/qobil_gn2.jpg' class='profile-picture'><div class='comment-details'><div class='am'>";
    
    if (record.kehadiran === "Hadir") {
    outputHTML +=  "<h4 class='commenter-name fsub1'>" + record.nama + "<i style='color: #733F37; margin-left: 5px;'class='bi bi-check-circle-fill'></i></h4>";
    } else {

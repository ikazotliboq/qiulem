    ...
    var url = "https://script.google.com/macros/s/AKfycbxcDLCKc8w2MaHryrlFxKe9WIDQ46F1xJv1lP0A7NJDSdICLf08Wjgn--WV-ppjO1vg/exec?action=read";
    ...
    outputHTML += "<div class='comment'><img src='https://raw.githubusercontent.com/qobilcdn/resource/main/images-wedding/qobil_IMG_20250702_040545.jpg' class='profile-picture'><div class='comment-details'><div class='am'>";
    
    if (record.kehadiran === "Hadir") {
    outputHTML +=  "<h4 class='commenter-name fsub1'>" + record.nama + "<i style='color: #957452; margin-left: 5px;'class='bi bi-check-circle-fill'></i></h4>";
    } else {
    ...
    const script_url = "https://script.google.com/macros/s/AKfycbxcDLCKc8w2MaHryrlFxKe9WIDQ46F1xJv1lP0A7NJDSdICLf08Wjgn--WV-ppjO1vg/exec";
